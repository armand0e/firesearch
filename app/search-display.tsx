  ...
  return (
    <div className="group flex items-start gap-2 text-xs py-1 animate-fade-in">
      ...
      <a
        ...
        className="opacity-0 group-hover:opacity-100 transition-opacity text-[10px] text-orange-600 dark:text-orange-400 mt-0.5 flex items-center gap-1 flex-shrink-0"
